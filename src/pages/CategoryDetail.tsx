...
import { categories as staticCategories, getProductsByCategory, staticProducts } from '@/data/products';
...
import { useProducts, useCategory } from '@/hooks/use-supabase-api';
...
export default function CategoryDetail() {
  ...
  const { data: apiProducts, isLoading } = useProducts({ categorySlug: slug, limit: 50 });
  ...
  const collection = useMemo(() => {
    if (apiCategory) {
      return {
        ...
        image: apiCategory.image_url || 'https://images.unsplash.com/photo-1617331721458-bd3bd3f9c7f8?w=800&q=80',
        productCount: 0,
      };
    }
