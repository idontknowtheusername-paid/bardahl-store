  ...
  return (
    <section className="py-10 md:py-16 bg-background">
      <div className="container">
        <div className="flex items-center justify-between mb-8">
          <div>
            <span className="text-primary text-sm font-bold tracking-widest uppercase">PRODUITS MIS EN AVANT</span>
            <h2 className="text-2xl md:text-3xl font-bold mt-1">Produits & Solutions sélectionnés</h2>
            <p className="text-muted-foreground text-base mt-2 hidden md:block">Des solutions testées pour protéger votre moteur, améliorer les performances et réduire l'usure.</p>
          </div>
