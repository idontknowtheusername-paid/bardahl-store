          ...
          <div className="max-w-2xl animate-slide-up">
            ...
            <div className="flex flex-wrap gap-4">
              <Button
                ...
                className="bg-primary text-primary-foreground hover:bg-primary/90 font-bold text-base px-8 group shadow-lg"
              >
              ...
              <Button
                size="lg"
                className="border border-white/30 text-white hover:border-white/50 hover:text-white font-bold backdrop-blur-sm bg-transparent hover:bg-white/10"
                asChild
              >
                <Link to="/categories">
